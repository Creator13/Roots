...
{
    [MenuItem("TEST/Bitmap generate")]
    private static void BitMapGeneratorEntry()
    {
        ...
        GenerateBitmap(maxSmooth, "C:/Users/cvanb/Desktop/testMetadata.bmp");
        ...
        GenerateBitmap(nodeTree, "C:/Users/cvanb/Desktop/testENT.bmp");
    }

    static void GenerateBitmap(FastNoise fastNoise, string filepath, ushort size = 512)
    {
        ...
        Debug.Log("Created " + filepath + ".bmp " + size + "x" + size);
    }
}
